module ApplicationHelper
  ...
  def author_level(author_x)
    ...
    if ( agg_author_usefuls <= 25 )
      ...
      tooltip_msg = "#{author_level} becomes an Explorer after getting #{next_level} useful votes. Click useful to help this #{author_level} get there."
      ...
      tooltip_msg = "#{author_level} becomes a Captain after getting #{next_level} useful votes. Click useful to help this #{author_level} get there."
      ...
      tooltip_msg = "#{author_level} becomes a Superstar after getting #{next_level} useful votes. Click useful to help this #{author_level} get there."
